...
if (!class_exists("mail_booster_email_log")) {

    class mail_booster_email_log {
...
if (!class_exists("mail_booster_email_log_writter")) {

    // This class is used to create logs.
    class mail_booster_email_log_writter {

        // This function is used to write success logs.
        public function mb_success_log($email_logs, $email_message, $debug_mode, $email_configuration_settings, $obj_mail_booster_manage_email) {
            $status = "Sent";
            $subject = $email_message->mb_get_subject();
            $this->mb_create_email_log($email_logs, $email_message);
            $this->mb_email_log($email_logs, $debug_mode, $status, $email_configuration_settings, $obj_mail_booster_manage_email, $email_message);
        }

        // This function is used to write failure logs.
        public function mb_failure_log($email_logs, $email_message = null, $debug_mode, $email_configuration_settings, $obj_mail_booster_manage_email) {
            $status = "Not Sent";
            $this->mb_create_email_log($email_logs, $email_message);
            $this->mb_email_log($email_logs, $debug_mode, $status, $email_configuration_settings, $obj_mail_booster_manage_email, $email_message);
        }
        ...
        public function mb_email_log($email_logs, $debug_mode, $status, $email_configuration_settings, $obj_mail_booster_manage_email, $message) {
            ...
            $cc_recipients = $obj_mail_booster_manage_email->mb_get_cc_recipients();
            $bcc_recipients = $obj_mail_booster_manage_email->mb_get_bcc_recipients();
            $cc_address = "";
            ...
            $wpdb->insert(mail_booster_meta(), $email_logs_data);
        }

        // This function is used to create email logs
        public function mb_create_email_log($email_logs, mail_booster_manage_email $email_message = null) {
            if ($email_message) {
