...
if (!class_exists("mail_booster_auth_host")) {
    ...
    class mail_booster_auth_host {
        ...
        public function __construct($settings_array) {
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-manage-token.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-manage-token.php";
            }
        ...
        /*
          Function Name: send_test_mail_booster
        ...
        public function send_test_mail_booster($to, $subject, $message, $headers = "", $attachments = "", $email_configuration_settings) {
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-send-mail.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-send-mail.php";
            }
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-manage-token.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-manage-token.php";
            }
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-zend-mail-helper.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-zend-mail-helper.php";
            }
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-smtp-transport.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/mail-booster-smtp-transport.php";
            }
            ...
            $obj_transport_registry = new mail_booster_register_transport();
            $obj_transport_registry->listing_transport_mail_booster(new mail_booster_smtp_transport($email_configuration_settings));
            $obj_wp_mail = new mail_booster_send_mail();
            return $obj_wp_mail->send_email_message_mail_booster($to, $subject, $message, $headers, $attachments, $email_configuration_settings);
        }
        ...
        public function microsoft_authentication() {
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/microsoft-authentication-mail-booster.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/microsoft-authentication-mail-booster.php";
            }
            ...
            $obj_microsoft_authentication_mail_booster = new microsoft_authentication_mail_booster($this->client_id, $this->client_secret, $this->authorization_token, $this->redirect_uri);

            $obj_microsoft_authentication_mail_booster->get_token_code(md5(rand()));
        }
        ...
        public function google_authentication() {
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/google-authentication-mail-booster.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/google-authentication-mail-booster.php";
            }
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/authentication-manager-mail-booster.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/authentication-manager-mail-booster.php";
            }
            ...
            $obj_google_authentication_mail_booster->get_token_code(md5(rand()));
        }
        ...
        public function microsoft_authentication_token($code) {
            ...
            $test_error = $obj_microsoft_authentication_mail_booster->process_token_Code(md5(rand()));
        ...
        public function yahoo_authentication() {
            ...
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/yahoo-authentication-mail-booster.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/yahoo-authentication-mail-booster.php";
            }
            if (file_exists(MAIL_BOOSTER_DIR_PATH . "includes/authentication-manager-mail-booster.php")) {
                include_once MAIL_BOOSTER_DIR_PATH . "includes/authentication-manager-mail-booster.php";
            }

            $obj_yahoo_authentication_mail_booster = new yahoo_authentication_mail_booster($this->client_id, $this->client_secret, $this->authorization_token, $this->redirect_uri);
            $obj_yahoo_authentication_mail_booster->get_token_code(md5(rand()));
        }
        ...
        public function yahoo_authentication_token($code) {
            ...
            $obj_yahoo_authentication_mail_booster = new yahoo_authentication_mail_booster($this->client_id, $this->client_secret, $this->authorization_token, $this->redirect_uri, $this->sender_email);

            $test_error1 = $obj_yahoo_authentication_mail_booster->process_token_Code(md5(rand()));
            if (isset($test_error1->error)) {
                return $test_error1;
            }
            $this->authorization_token->save_token_mail_booster();
                ...
                if ($email_configuration_data_array["mailer_type"] == "smtp") {
                    if (!function_exists("wp_mail")) {
                        ...
                        function wp_mail($to, $subject, $message, $headers = "", $attachments = "") {
                            ...
                            $obj_send_test_mail = new mail_booster_auth_host($email_configuration_settings);
                            $result = $obj_send_test_mail->send_test_mail_booster($to, $subject, $message, $headers, $attachments, $email_configuration_settings);
                            return $result;
                        }
