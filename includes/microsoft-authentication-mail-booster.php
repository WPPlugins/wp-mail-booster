...
if (!class_exists("microsoft_authentication_mail_booster")) {

    class microsoft_authentication_mail_booster extends token_manager_mail_booster {
        ...
        public function process_token_Code($transactionId) {
            if (isset($_REQUEST["access_token"])) {
                ...
                if (isset($microsoft_secret_key->error)) {
                    ...
                    $this->get_authorization_token()->set_vendorname_mail_booster("microsoft");
                    return "1";
                }
            } else {
                return false;
