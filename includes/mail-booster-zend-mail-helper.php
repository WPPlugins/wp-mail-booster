...
if (!class_exists("mail_booster_zend_mail_helper")) {
    ...
    class mail_booster_zend_mail_helper {
        ...
        public static function email_validation_mail_booster($email) {
            ...
            require_once MAIL_BOOSTER_DIR_PATH . "lib/zend/validate/emailaddress.php";
            if (!isset(mail_booster_zend_mail_helper::$validate_email)) {
                mail_booster_zend_mail_helper::$validate_email = new mail_booster_Zend_Validate_EmailAddress();
            }
            return mail_booster_zend_mail_helper::$validate_email->isValid($email);
        }
