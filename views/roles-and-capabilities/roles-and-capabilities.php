...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        return;
    } else if (roles_and_capabilities_mail_booster == "1") {
                            ...
                            <div class="form-body">
                                ...
                                if ($mb_message_translate_help != "") {
                                    ...
                                    <div class="note note-danger">
                                        ...
                                        <strong><?php echo $mb_message_translate_help; ?><br/><?php echo $mb_kindly_click; ?><a href="javascript:void(0);" data-popup-open="ux_open_popup_translator" class="custom_links" onclick="show_pop_up_mail_booster();"><?php echo $mb_message_translate_here; ?></a></strong>
                                    </div>
                                    <?php
                                }
                                ?>
                                <div class="form-group">
                                    <label class="control-label">
                                        ...
                                        <span class="required" aria-required="true">* ( <?php echo $mb_premium_editions_label ?> ) </span>
                                    </label>
                                    <table class="table table-striped table-bordered table-margin-top" id="ux_tbl_mail_booster_roles">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_author" id="ux_chk_author"  value="1" onclick="show_roles_capabilities_mail_booster(this, 'ux_div_author_roles');" <?php echo $roles_and_capabilities[1] == "1" ? "checked = checked" : "" ?>>
                                                    <?php echo $mb_roles_capabilities_author; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_editor" id="ux_chk_editor" value="1" onclick="show_roles_capabilities_mail_booster(this, 'ux_div_editor_roles');" <?php echo $roles_and_capabilities[2] == "1" ? "checked = checked" : "" ?>>
                                                    <?php echo $mb_roles_capabilities_editor; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_contributor" id="ux_chk_contributor"  value="1" onclick="show_roles_capabilities_mail_booster(this, 'ux_div_contributor_roles');" <?php echo $roles_and_capabilities[3] == "1" ? "checked = checked" : "" ?>>
                                                    <?php echo $mb_roles_capabilities_contributor; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_subscriber" id="ux_chk_subscriber" value="1" onclick="show_roles_capabilities_mail_booster(this, 'ux_div_subscriber_roles');" <?php echo $roles_and_capabilities[4] == "1" ? "checked = checked" : "" ?>>
                                                    <?php echo $mb_roles_capabilities_subscriber; ?>
                                                </th>
                                                <th>
                                                    <input type="checkbox"  name="ux_chk_others_privileges" id="ux_chk_others_privileges" value="1" onclick="show_roles_capabilities_mail_booster(this, 'ux_div_other_privileges_roles');" <?php echo $roles_and_capabilities[5] == "1" ? "checked = checked" : "" ?>>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_administrator">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_test_connectivity_admin" disabled="disabled" checked="checked" id="ux_chk_test_connectivity_admin" value="1">
                                                            <?php echo $mb_roles_capabilities_connectivity_test; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:none;">
                                                            <input type="checkbox" name="ux_chk_error_logs_admin" id="ux_chk_error_logs_admin" value="1" disabled="disabled" checked="checked">
                                        ...
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_author">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_author" id="ux_chk_full_control_author" value="1" onclick="full_control_function_mail_booster(this, 'ux_div_author_roles');" <?php echo isset($author) && $author[0] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_test_connectivity_author" id="ux_chk_test_connectivity_author" value="1" <?php echo isset($author) && $author[3] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_connectivity_test; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:none;">
                                                            <input type="checkbox" name="ux_chk_error_logs_author" id="ux_chk_error_logs_author" value="1" <?php echo isset($author) && $author[8] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_error_logs_label; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                        ...
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_editor">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_editor" id="ux_chk_full_control_editor" value="1" onclick="full_control_function_mail_booster(this, 'ux_div_editor_roles');" <?php echo isset($editor) && $editor[0] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_chk_test_connectivity_editor" id="ux_chk_test_connectivity_editor" value="1" <?php echo isset($editor) && $editor[3] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_connectivity_test; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:none;">
                                                            <input type="checkbox" name="ux_chk_error_logs_editor" id="ux_chk_error_logs_editor" value="1" <?php echo isset($editor) && $editor[8] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_error_logs_label; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                        ...
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_contributor">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_contributor" id="ux_chk_full_control_contributor" value="1" onclick="full_control_function_mail_booster(this, 'ux_div_contributor_roles');" <?php echo isset($contributor) && $contributor[0] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_txt_connectivity_test_contributor" id="ux_txt_connectivity_test_contributor" value="1" <?php echo isset($contributor) && $contributor[3] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_connectivity_test; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:none;">
                                                            <input type="checkbox" name="ux_chk_error_logs_contributor" id="ux_chk_error_logs_contributor" value="1" <?php echo isset($contributor) && $contributor[8] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_error_logs_label; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                        ...
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_subscriber">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_subscriber" id="ux_chk_full_control_subscriber" value="1" onclick="full_control_function_mail_booster(this, 'ux_div_subscriber_roles');" <?php echo isset($subscriber) && $subscriber[0] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_txt_connectivity_test_subscriber" id="ux_txt_connectivity_test_subscriber" value="1" <?php echo isset($subscriber) && $subscriber[3] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_connectivity_test; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:none;">
                                                            <input type="checkbox" name="ux_chk_error_logs_subscriber" id="ux_chk_error_logs_subscriber" value="1" <?php echo isset($subscriber) && $subscriber[8] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_error_logs_label; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                        ...
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_other_roles_privileges">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_other_privileges_roles" id="ux_chk_full_control_other_privileges_roles" value="1" onclick="full_control_function_mail_booster(this, 'ux_div_other_privileges_roles');" <?php echo isset($other_privileges) && $other_privileges[0] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ux_txt_connectivity_test_others" id="ux_txt_connectivity_test_others" value="1" <?php echo isset($other_privileges) && $other_privileges[3] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_connectivity_test; ?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display:none;">
                                                            <input type="checkbox" name="ux_chk_error_logs_others" id="ux_chk_error_logs_others" value="1" <?php echo isset($other_privileges) && $other_privileges[8] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_error_logs_label; ?>
                                                        </td>
                                                        <td>
                                                        </td>
                                        ...
                                        <div class="table-margin-top">
                                            <table class="table table-striped table-bordered table-hover" id="ux_tbl_other_roles">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 40% !important;">
                                                            <input type="checkbox" name="ux_chk_full_control_other_roles" id="ux_chk_full_control_other_roles" value="1" onclick="full_control_function_mail_booster(this, 'ux_div_other_roles');" <?php echo $details_roles_capabilities["others_full_control_capability"] == "1" ? "checked = checked" : "" ?>>
                                                            <?php echo $mb_roles_capabilities_full_control; ?>
                                                        </th>
                                                    </tr>
                                                </thead>
