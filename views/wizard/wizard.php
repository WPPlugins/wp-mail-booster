...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        ...
        $mail_booster_check_status = wp_create_nonce("mail_booster_check_status");
        ?>
        <html>
            <body>
                <div><div><div>
                                ...
                                <div class="page-content">
                                    ...
                                    <div class="row row-custom">
                                        <div class="col-md-12 textalign">
                                            ...
                                            <p><strong>Mail Booster will still work fine.</strong></p>
                                        </div>
                                    </div>
                                    <div class="row row-custom">
                                        <div class="col-md-12">
                                            <a class="permissions" onclick="show_hide_details_mail_booster();">What permissions are being granted?</a>
                                        </div>
                                        ...
                                        <div class="col-md-12 allow">
                                            <div class="tech-banker-actions">
                                                <a onclick="plugin_stats_mail_booster('opt_in');" class="button button-primary-wizard">
                                                    <strong>Opt-In &amp; Continue </strong>
                                                    <i class="dashicons dashicons-arrow-right-alt"></i>
                                                </a>
                                                <a onclick="plugin_stats_mail_booster('skip');" class="button button-secondary-wizard" tabindex="2">
