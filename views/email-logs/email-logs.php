...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        return;
    } else if (email_logs_mail_booster == "1") {
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ux_txt_mb_start_date" id="ux_txt_mb_start_date" value="<?php echo date("m/d/Y", $start_date); ?>" placeholder="<?php echo $mb_start_date_placeholder; ?>" onfocus="prevent_datepicker_mail_booster(this.id);">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ux_txt_mb_end_date" id="ux_txt_mb_end_date" value="<?php echo date("m/d/Y", $end_date); ?>" placeholder="<?php echo $mb_end_date_placeholder; ?>" onfocus="prevent_datepicker_mail_booster(this.id);">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-top-margin">
                                    <select name="ux_ddl_email_logs" id="ux_ddl_email_logs" class="custom-bulk-width">
                                        ...
                                        <option value="delete" style="color:red;"><?php echo $mb_email_logs_delete; ?> ( <?php echo $mb_premium_editions_label; ?> ) </option>
                                    </select>
                                    <input type="button" class="btn vivid-green" name="ux_btn_apply" id="ux_btn_apply" value="<?php echo $mb_email_logs_apply; ?>" onclick="premium_edition_notification_mail_booster();">
                                </div>
                                        ...
                                        foreach ($unserialized_email_logs_data as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td id="ux_email_date_time_<?php echo intval($value["id"]) ?>">
                                                    <?php echo date_i18n("d M Y h:i A", doubleval($value["timestamp"])); ?>
                                                </td>
                                                ...
                                                <td class="custom-alternative">
                                                    <a href="javascript:void(0);">
                                                        <i class="icon-custom-reload tooltips" data-original-title="<?php echo $mb_resend; ?>" onclick="premium_edition_notification_mail_booster();" data-placement="top"></i>
                                                    </a> |
                                                    <?php
                                                    if (isset($value["debug_mode"])) {
                                                        ?>
                                                        <a onclick="premium_edition_notification_mail_booster();">
                                                    ...
                                                    <a href="javascript:void(0);">
                                                        <i class="icon-custom-trash tooltips" data-original-title="<?php echo $mb_email_logs_delete; ?>" onclick="premium_edition_notification_mail_booster();" data-placement="top"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php
