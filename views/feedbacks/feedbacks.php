 ...
 *
 * @author  Tech Banker
 * @package wp-mail-booster/views/feedbacks
 * @version 2.0
 */
if (!defined("ABSPATH")) {
    exit;
                            ...
                            <div class="form-body">
                                <div class="note note-warning">
                                    ...
                                    if ($mb_message_translate_help != "") {
                                        ?>
                                        <h4 class="block">
                                            <strong><?php echo $mb_message_translate_help; ?><br/><?php echo $mb_kindly_click; ?><a href="javascript:void(0);" data-popup-open="ux_open_popup_translator" class="custom_links_feature" onclick="show_pop_up_mail_booster();"><?php echo $mb_message_translate_here; ?></a></strong>
                                        </h4>
                                        <?php
                                    }
                                    ?>
