...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        return;
    } else if (email_configuration_mail_booster == "1") {
                            ...
                            <div class="tab-content" id="mailer_settings">
                                <form id="ux_frm_email_configuration">
                                    <div id="ux_div_first_step">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="ux_ddl_from_name" id="ux_ddl_from_name" class="form-control" onchange="mail_booster_from_name_override()">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="ux_ddl_from_email" id="ux_ddl_from_email" class="form-control" onchange="mail_booster_from_email_override()">
                                                        <option value="override"><?php echo $mb_override; ?></option>
                                                        <option value="dont_override"><?php echo $mb_dont_override; ?></option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="pull-right">
                                                <button class="btn vivid-green" name="ux_btn_next_step_second" id="ux_btn_next_step_second" onclick="mail_booster_move_to_second_step();"><?php echo $mb_next_step; ?> >> </button>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="ux_div_second_step" style="display:none">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="ux_txt_email_address" id="ux_txt_email_address" value="<?php echo isset($email_configuration_array["email_address"]) ? esc_html($email_configuration_array["email_address"]) : ""; ?>" placeholder="<?php echo $mb_email_configuration_email_address_placeholder; ?>" onblur="mail_booster_get_host_port()">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ux_txt_host" id="ux_txt_host" value="<?php echo isset($email_configuration_array["hostname"]) ? esc_html($email_configuration_array["hostname"]) : ""; ?>" placeholder="<?php echo $mb_email_configuration_smtp_host_placeholder; ?>" onblur="change_link_content_mail_booster();">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="ux_txt_port" id="ux_txt_port" value="<?php echo isset($email_configuration_array["port"]) ? esc_html($email_configuration_array["port"]) : ""; ?>" placeholder="<?php echo $mb_email_configuration_smtp_port_placeholder; ?>" onfocus="paste_only_digits_mail_booster(this.id);">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ux_ddl_mb_authentication" id="ux_ddl_mb_authentication" class="form-control" onchange="select_credentials_mail_booster()">
                                        ...
                                        <div class="form-actions">
                                            <div class="pull-left">
                                                <button type="button" class="btn vivid-green" name="ux_btn_previsious_step_first" id="ux_btn_previsious_step_first" onclick="mail_booster_move_to_first_step()"> << <?php echo $mb_previous_step; ?></button>
                                            </div>
                                            <div class="pull-right">
                                                <button  class="btn vivid-green" name="ux_btn_next_step_third" id="ux_btn_next_step_third" onclick="mail_booster_move_to_third_step();"><?php echo $mb_next_step; ?> >></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                    ...
                                    <form id="ux_frm_test_email_configuration">
                                        <div id="ux_div_test_mail">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ux_txt_subject" id="ux_txt_subject" value="Test Email - Mail booster" placeholder="<?php echo $mb_email_configuration_subject_test_placeholder; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label">
                                                ...
                                                <?php
                                                $email_configuration = "This is a demo Test Email for Email Setup - Mail Booster";
                                            ...
                                            <div class="form-actions">
                                                <div class="pull-left">
                                                    <button type="button" class="btn vivid-green" name="ux_btn_previsious_step_second" id="ux_btn_previsious_step_second"  onclick="mail_booster_second_step_settings()"> << <?php echo $mb_previous_step; ?></button>
                                                </div>
                                                <div class="pull-right">
                                                    <button class="btn vivid-green" name="ux_btn_save_test_email"  id="ux_btn_save_test_email" onclick="mail_booster_send_test_mail()"><?php echo $mb_email_configuration_send_test_email; ?></button>
                                                    <button type="button" class="btn vivid-green" name="ux_btn_save_changes" id="ux_btn_save_changes" onclick="mail_booster_save_changes()"> <?php echo $mb_save_changes; ?></button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="ux_div_mail_console" style="display: none;">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <div class="pull-right">
                                                    <input type="button" class="btn vivid-green" name="ux_btn_another_test_email" onclick="another_test_email_mail_booster();" id="ux_btn_another_test_email" value="<?php echo $mb_email_configuration_send_another_test_email; ?>">
                                                    <button type="button" class="btn vivid-green" name="ux_btn_save_changes_on_another_mail" id="ux_btn_save_changes_on_another_mail" onclick="mail_booster_save_changes()"> <?php echo $mb_save_changes; ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
