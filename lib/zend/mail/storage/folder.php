...
class mail_booster_Zend_Mail_Storage_Folder implements RecursiveIterator {

    /**
     * subfolders of folder array(localName => mail_booster_Zend_Mail_Storage_Folder folder)
     * @var array
     */
    protected $_folders;
     ...
     * @param array  $folders    init with given instances of mail_booster_Zend_Mail_Storage_Folder as subfolders
     */
    ...
    public function hasChildren() {
        ...
        return $current && $current instanceof mail_booster_Zend_Mail_Storage_Folder && !$current->isLeaf();
    }

    /**
     * implements RecursiveIterator::getChildren()
     *
     * @return mail_booster_Zend_Mail_Storage_Folder same as self::current()
     */
     ...
     *
     * @return mail_booster_Zend_Mail_Storage_Folder current folder
     */
     ...
     * @return mail_booster_Zend_Mail_Storage_Folder folder named $folder
    ...
    public function __get($name) {
        if (!isset($this->_folders[$name])) {
            ...
            throw new mail_booster_Zend_Mail_Storage_Exception("no subfolder named $name");
        }
     ...
     * @param mail_booster_Zend_Mail_Storage_Folder $folder instance for new subfolder
     * @return null
     */
    public function __set($name, mail_booster_Zend_Mail_Storage_Folder $folder) {
