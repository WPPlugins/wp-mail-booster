...
abstract class mail_booster_Zend_Mail_Storage_Abstract implements Countable, ArrayAccess, SeekableIterator {
     ...
     * @var string
     */
    protected $_messageClass = 'mail_booster_Zend_Mail_Message';
    ...
    public function __get($var) {
        ...
        throw new mail_booster_Zend_Mail_Storage_Exception($var . ' not found');
    }
     ...
     *
     * @param int $id number of message
     * @return mail_booster_Zend_Mail_Message
     */
     ...
     *
     * @param int $id
     * @return mail_booster_Zend_Mail_Message message object
     */
    ...
    public function offsetSet($id, $value) {
        ...
        throw new mail_booster_Zend_Mail_Storage_Exception('cannot write mail messages via array access');
    }
     ...
     * Iterator::current()
     *
     * @return mail_booster_Zend_Mail_Message current message
     */
