 ...
 * @license http://framework.zend.com/license/new-bsd	  New BSD License
 */
class mail_booster_Zend_Mail_Storage_Mbox extends mail_booster_Zend_Mail_Storage_Abstract {
    ...
    public function __construct($params) {
        ...
        if (!isset($params->filename) /* || mail_booster_Zend_Loader::isReadable($params['filename']) */) {
            /**
             * @see mail_booster_Zend_Mail_Storage_Exception
             */
            if (file_exists(MAIL_BOOSTER_DIR_PATH . 'lib/zend/mail/storage/exception.php')) {
            ...
            throw new mail_booster_Zend_Mail_Storage_Exception('no valid filename given in params');
        }
    ...
    protected function _openMboxFile($filename) {
        ...
        if (!$this->_fh) {
            ...
            throw new mail_booster_Zend_Mail_Storage_Exception('cannot open mbox file');
        }
        ...
        if (!$this->_isMboxFile($this->_fh, false)) {
            ...
            throw new mail_booster_Zend_Mail_Storage_Exception('file is not a valid mbox format');
        }
    ...
    public function removeMessage($id) {
        ...
        throw new mail_booster_Zend_Mail_Storage_Exception('mbox is read-only');
    }
