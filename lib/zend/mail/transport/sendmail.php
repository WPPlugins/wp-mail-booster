 ...
 * @license	 http://framework.zend.com/license/new-bsd	  New BSD License
 */
class mail_booster_Zend_Mail_Transport_Sendmail extends mail_booster_Zend_Mail_Transport_Abstract {
     ...
     * Constructor.
     *
     * @param  string|array|mail_booster_Zend_Config $parameters OPTIONAL (Default: null)
     * @return void
     */
    public function __construct($parameters = null) {
        if ($parameters instanceof mail_booster_Zend_Config) {
     ...
     * @access public
     * @return void
     * @throws mail_booster_Zend_Mail_Transport_Exception if parameters is set
     * 			but not a string
     * @throws mail_booster_Zend_Mail_Transport_Exception on mail() failure
     */
    public function _sendMail() {
        if ($this->parameters === null) {
            ...
            if (!is_string($this->parameters)) {
                ...
                throw new mail_booster_Zend_Mail_Transport_Exception(
        ...
        if ($this->_errstr !== null || !$result) {
            ...
            throw new mail_booster_Zend_Mail_Transport_Exception('Unable to send mail. ' . $this->_errstr);
        }
    }
     ...
     * @param	array $headers
     * @return  void
     * @throws  mail_booster_Zend_Mail_Transport_Exception
     */
    protected function _prepareHeaders($headers) {
        if (!$this->_mail) {
            ...
            throw new mail_booster_Zend_Mail_Transport_Exception('_prepareHeaders requires a registered Zend_Mail object');
        }
        ...
        if (0 === strpos(PHP_OS, 'WIN')) {
            ...
            if (empty($this->recipients)) {
                ...
                throw new mail_booster_Zend_Mail_Transport_Exception('Missing To addresses');
            }
        } else {
            ...
            if (!isset($headers['To'])) {
                ...
                throw new mail_booster_Zend_Mail_Transport_Exception('Missing To header');
            }
