 ...
 * @license	 http://framework.zend.com/license/new-bsd	  New BSD License
 */
class mail_booster_Zend_Mail_Transport_File extends mail_booster_Zend_Mail_Transport_Abstract {
     ...
     * Constructor
     *
     * @param  array|mail_booster_Zend_Config $options OPTIONAL (Default: null)
     * @return void
     */
     ...
     *
     * @return void
     * @throws mail_booster_Zend_Mail_Transport_Exception on not writable target directory
     * @throws mail_booster_Zend_Mail_Transport_Exception on file_put_contents() failure
     */
    protected function _sendMail() {
        ...
        if (!is_writable(dirname($file))) {
            ...
            throw new mail_booster_Zend_Mail_Transport_Exception(sprintf(
        ...
        if (!file_put_contents($file, $email)) {
            ...
            throw new mail_booster_Zend_Mail_Transport_Exception('Unable to send mail');
        }
    }
     ...
     *
     * @param mail_booster_Zend_Mail_Transport_File File transport instance
     * @return string
     */
