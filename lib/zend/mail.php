...
class mail_booster_Zend_Mail extends mail_booster_Zend_Mime_Message {
     ...
     * advanced settings)
     */
    public function createAttachment($body, $mimeType = mail_booster_Zend_Mime::TYPE_OCTETSTREAM, $disposition = mail_booster_Zend_Mime::DISPOSITION_ATTACHMENT, $encoding = mail_booster_Zend_Mime::ENCODING_BASE64, $filename = null) {
