...
/**
 * @see mail_booster_Zend_Validate_Abstract
 */
 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class mail_booster_Zend_Validate_EmailAddress extends mail_booster_Zend_Validate_Abstract {
    ...
    protected $_options = array(
        ...
        'deep' => false,
        'domain' => true,
        'allow' => mail_booster_Zend_Validate_Hostname::ALLOW_DNS,
        'hostname' => null
    );
     ...
     * 'hostname' => A hostname validator, see mail_booster_Zend_Validate_Hostname
     * 'allow'  => Options for the hostname validator, see mail_booster_Zend_Validate_Hostname::ALLOW_*
     * 'mx'     => If MX check should be enabled, boolean
     * 'deep'   => If a deep MX check should be done, boolean
     *
     * @param array|string|mail_booster_Zend_Config $options OPTIONAL
     */
    public function __construct($options = array()) {
        if ($options instanceof mail_booster_Zend_Config) {
     ...
     *
     * @param array $options
     * @return mail_booster_Zend_Validate_EmailAddress Provides a fluent inteface
     */
     ...
     * @return mail_booster_Zend_Validate_Abstract Provides a fluent interface
     ...
     *
     * @return mail_booster_Zend_Validate_Hostname
     */
    ...
    /**
     * @param mail_booster_Zend_Validate_Hostname $hostnameValidator OPTIONAL
     * @param int  $allow  OPTIONAL
     * @return $this
     */
    public function setHostnameValidator(mail_booster_Zend_Validate_Hostname $hostnameValidator = null, $allow = mail_booster_Zend_Validate_Hostname::ALLOW_DNS) {
        if (!$hostnameValidator) {
            $hostnameValidator = new mail_booster_Zend_Validate_Hostname($allow);
        }
    ...
    public function setValidateMx($mx) {
        if ((bool) $mx && !$this->validateMxSupported()) {
            ...
            throw new mail_booster_Zend_Validate_Exception('MX checking not available on this system');
        }
