...
/**
 * @see mail_booster_Zend_Validate_Ip
 */
if (file_exists(MAIL_BOOSTER_DIR_PATH . 'lib/zend/validate/ip.php')) {
    require_once MAIL_BOOSTER_DIR_PATH . 'lib/zend/validate/ip.php';
}
 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class mail_booster_Zend_Validate_Hostname extends mail_booster_Zend_Validate_Abstract {
     ...
     *
     * @return mail_booster_Zend_Validate_Ip
     */
    ...
    /**
     * @param mail_booster_Zend_Validate_Ip $ipValidator OPTIONAL
     * @return mail_booster_Zend_Validate_Hostname
     */
    public function setIpValidator(mail_booster_Zend_Validate_Ip $ipValidator = null) {
        if ($ipValidator === null) {
            $ipValidator = new mail_booster_Zend_Validate_Ip();
        }
     ...
     *
     * @param	integer $allow
     * @return mail_booster_Zend_Validate_Hostname Provides a fluent interface
     */
     ...
     *
     * @param	string $value
     * @throws mail_booster_Zend_Validate_Exception if a fatal error occurs for validation process
     * @return boolean
     */
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            do {
                ...
                if (preg_match('/([^.]{2,63})$/iu', end($domainParts), $matches) || (array_key_exists(end($domainParts), $this->_validIdns))) {
                     ...
                     * @see mail_booster_Zend_Validate_Hostname_Interface
                     */
