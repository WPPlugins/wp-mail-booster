 ...
 * @license http://framework.zend.com/license/new-bsd New BSD License
 */
class mail_booster_Zend_Validate_Ip extends mail_booster_Zend_Validate_Abstract {
    ...
    public function setOptions($options) {
        ...
        if (!$this->_options['allowipv4'] && !$this->_options['allowipv6']) {
            ...
            throw new mail_booster_Zend_Validate_Exception('Nothing to validate. Check your options');
        }
