...
if (!is_user_logged_in()) {
    ...
    if (!$access_granted) {
        ...
        class plugin_info_wp_mail_booster {
            /*
              Function Name: get_plugin_info_wp_mail_booster
              Parameters: No
              Decription: This function is used to return the information about plugins.
              Created On: 21-04-2017 12:53
              Created By: Tech Banker Team
             */

            function get_plugin_info_wp_mail_booster() {
